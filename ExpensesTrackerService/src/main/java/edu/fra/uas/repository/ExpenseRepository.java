...
/**
 * ExpenseRepository is a mock repository for storing and managing Expense objects.
 * It extends HashMap to store expenses in-memory, using the expense ID as the key.
 * 
 * This repository is used by the ExpenseService to simulate data storage and retrieval.
